# چیت شیت و آموزش فارسی و کامل manifest.json در وب اپلیکیشن های PWA

شما میتونید با استفاده از فایل مینفست و ورکر-سرویس به راحتی وبسایت خودتون رو به وب اپلیکیشن تبدیل کنید و قابلیت بارگذاری آفلاین و کش کردن فایل ها و نصب و پشتیبانی روی سیستم عامل های مختلف رو داشته باشید.
